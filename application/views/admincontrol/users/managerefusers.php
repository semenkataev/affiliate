												...
												<td class="txt-cntr">
													...
													<div class="dropdown">
														...
														<div class="dropdown-content">
															...
															<a onclick="shareinsocialmedia('https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url();?>usercontrol/<?php echo $users['product_slug'];?>/<?php echo $user['id'];?>&amp;title=<?= __('admin.buy_product_earn_by_affiliate_program') ?>')" href=""><i class="fa fa-facebook fa-6" aria-hidden="true"></i></a>
															...
															<a onclick="shareinsocialmedia('http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo base_url();?>product/<?php echo $product['product_slug'];?>/<?php echo $user['id'];?>&amp;title=<?= __('admin.buy_product_earn_by_affiliate_program') ?>')" href=""><i class="fa fa-linkedin fa-6" aria-hidden="true"></i></a>
															
															<a onclick="shareinsocialmedia('http://twitter.com/home?status=<?= __('admin.buy_product_earn_by_affiliate_program') ?>+<?php echo base_url();?>product/<?php echo $product['product_slug'];?>/<?php echo $user['id'];?>')" href=""><i class="fa fa-twitter fa-6" aria-hidden="true"></i></a>
															
															<a href="mailto:?subject=<?= __('admin.buy_product_earn_by_affiliate_program') ?>&amp;body=Check out this site <?php echo base_url();?>product/<?php echo $product['product_slug'];?>/<?php echo $user['id'];?>" title="Share by Email">
