        ...
        <div class="thankyouheader">
          <div class="container">
            <div class="thankyouheader-row">
               <a class="no-print" href="<?= base_url('store/orders') ?>"><img src="<?= base_url('assets/store/default/'); ?>img/thankyouback.png" class="thankyouback-img" alt="<?= __('store.back') ?>"></a>
               <?php  $logo = ($store_setting['logo']) ? base_url('assets/images/site/'.$store_setting['logo']) : base_url('assets/store/default/').'img/logo.png'; ?>
               <a href="<?=base_url('store')?>"><img src="<?= $logo; ?>" class="thankyoulogo" Alt="All4bussness"></a>
               <a class="no-print " href="<?=base_url('store/print/'.$order['id'].'?print=1')?>"><img src="<?= base_url('assets/store/default/'); ?>img/thankyouprint.png" class="thankyouprint-img" alt="<?= __('store.print') ?>"></a>
            </div>
         </div>
      </div>
                     ...
                     <div class="my-order-details-bottom">
                        ...
                        <?php if($order['allow_shipping']){ ?>
                           <div class="cart-wrapper order-details-bottom-right my-orders">
                              ...
                              <ul class="cart-items-row">
                                 <li><span class="my-orders-text"><?= __('store.phone') ?></span></li>
                                 <li><span class="my-orders-text"><?php echo $order['phone'] ?></span></li>
                              </ul>
                              <ul class="cart-items-row">
