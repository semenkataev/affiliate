  ...
  */
  class Datatables
  {
    ...
    */
     ...
     * @return $this
     */
    public function order_by($val1,$val2)
    {
//      $this->order_by[] = $val;
       $this->order_by[] = array($val1,$val2);
      $this->ci->db->order_by($val1,$val2);
      return $this;
    }
    /**
    ...
    */
    private function get_total_results($filtering = FALSE)
    {
      ...
      $subquery = preg_replace('/^SELECT.+?FROM/is', "SELECT 1 FROM", $subquery);
